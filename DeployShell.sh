...
az webapp config appsettings set --name ${service_name} --resource-group ${rg_name} --settings DOCKER_REGISTRY_SERVER_USERNAME=${reg_name} DOCKER_REGISTRY_SERVER_PASSWORD=${password} DOCKER_REGISTRY_SERVER_URL=${reg_name}.azurecr.io
